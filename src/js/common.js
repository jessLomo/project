 ...
 * 数组相关
 * [随机名字——简单版]
 * @return{String}[返回数组元素字符串]
 */
function getName(){
    var idx=parseInt(Math.random()*namelist.length);
    return namelist[idx];
}
...
//封装节点相关的——可用对象的方式进行封装
 var element = {
     ...
     * @return{Element}     [返回元素的子元素]
     */
    children:function(element){

        var nodes=element.childNodes;

        // var arr = element.get(nodes);//得到子元素
